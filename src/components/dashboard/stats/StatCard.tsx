...
export function StatCard({ 
  ...
  return (
    <div 
      className={`group crm-tile hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ${className}`}
    >
        ...
        <div className="flex items-center justify-between mb-4">
          <div className={`relative ${color} rounded-xl p-3 
            ...
            <div className="relative z-10">
              <Icon className={`w-6 h-6 ${resolvedTextColor}
          ...
          <div className={`text-2xl font-bold ${resolvedTextColor}
